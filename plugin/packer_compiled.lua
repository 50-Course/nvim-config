...
_G.packer_plugins = {
  ...
  ["glow.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/erioluwa/.local/share/nvim/site/pack/packer/opt/glow.nvim",
  ...
  ["nvim-dap"] = {
    config = { "\27LJ\2\n,\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\17codemage.dap\frequire\0" },
    loaded = true,
  ...
  ["nvim-treesitter"] = {
    config = { "\27LJ\2\n3\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\24codemage.treesitter\frequire\0" },
    loaded = true,
  ...
  ["tokyonight.nvim"] = {
    loaded = false,
    needs_bufread = false,
    path = "/home/erioluwa/.local/share/nvim/site/pack/packer/opt/tokyonight.nvim",
  ...
  ["vim-test"] = {
    commands = { "TestFile", "TestNearest", "TestLast", "TestSuite", "TestVisit" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
